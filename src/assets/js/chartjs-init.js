(function($) {
			...
			new Chart(areaChart_2, {
				...
				data: {
					...
					datasets: [
						{
							label: "Activity",
							data: [350, 250, 420, 320, 150, 200, 20, 0, 100],
							borderColor: "#147AD6",
							borderWidth: "3",
 ...
 var doughnutChart = function(){
		if(jQuery('#doughnut_chart').length > 0 ){
			var data = [20, 25, 8, 12, 23, 10];
			//doughut chart
			const doughnut_chart = document.getElementById("doughnut_chart").getContext('2d');
			// doughnut_chart.height = 350,
			// doughnut_chart.width = 350,
			new Chart(doughnut_chart, {
				...
				data: {
					...
					datasets: [{
						...
						hoverBackgroundColor: [
							"rgba(202, 119, 227, 0.7)",
							"rgba(110, 63, 173, 0.7)",
							"rgba(237, 143, 108, 0.7)",
							"rgba(32, 140, 208, 0.7)",
							"rgba(115, 245, 220, 0.7)",
							"rgba(245, 107, 144, 0.7)"
						],
